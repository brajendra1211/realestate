export function WhatsAppButton({ phoneNumber }: { phoneNumber?: string | null }) {
  ...
  return (
    <a
      ...
      className="animate-pulse-ring fixed bottom-20 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-green-500 text-white shadow-lg transition hover:scale-105 hover:bg-green-600 sm:bottom-5"
    >
